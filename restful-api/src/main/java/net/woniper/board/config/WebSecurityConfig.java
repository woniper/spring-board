    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/kindBoard").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/kindBoard").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/kindBoard").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/kindBoard").hasAnyRole("ADMIN", "USER")
